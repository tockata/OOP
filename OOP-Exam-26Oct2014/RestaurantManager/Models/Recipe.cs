...
namespace RestaurantManager.Models
{
    public abstract class Recipe : IRecipe
    {
        ...
        protected Recipe(string name, decimal price, int calories, int quantityPerServing,
        ...
        {
            string unit = this.Unit.ToString() == "Grams" ? "g" : "ml";

            string recipe = "==  " + this.Name + " == $" + Math.Round(this.Price, 2) + "\n";
            recipe += "Per serving: " + this.QuantityPerServing + " " + unit + 
                ", " + this.Calories + " kcal\n";
            recipe += "Ready in " + this.TimeToPrepare + " minutes";
